...
import com.bsarias.pokeapi.core.framework.di.DispatcherModule
...
@Singleton
@Component(modules = [AppSubcomponents::class, NetworkModule::class, DatabaseModule::class, DispatcherModule::class])
